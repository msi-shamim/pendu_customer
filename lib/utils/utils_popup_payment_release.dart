...
class PaymentReleasedPopupUtils extends StatefulWidget {
  @override
  _PaymentReleasedPopupUtilsState createState() => _PaymentReleasedPopupUtilsState();
}

class _PaymentReleasedPopupUtilsState extends State<PaymentReleasedPopupUtils> {
  double _rating;
