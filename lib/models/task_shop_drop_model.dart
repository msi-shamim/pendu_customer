...
//
//     final postTaskShopDropModel = postTaskShopDropModelFromMap(jsonString);

import 'dart:convert';

class PostTaskShopDropModel {
  PostTaskShopDropModel({
    this.status,
    this.message,
    this.data,
  });
  ...
  factory PostTaskShopDropModel.fromJson(String str) => PostTaskShopDropModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory PostTaskShopDropModel.fromMap(Map<String, dynamic> json) => PostTaskShopDropModel(
