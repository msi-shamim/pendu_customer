...
//
//     final putUpdateUser = putUpdateUserFromMap(jsonString);

import 'dart:convert';

class PutUpdateUserModel {
  PutUpdateUserModel({
    this.status,
    this.message,
    this.data,
  ...
  factory PutUpdateUserModel.fromJson(String str) => PutUpdateUserModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory PutUpdateUserModel.fromMap(Map<String, dynamic> json) => PutUpdateUserModel(
