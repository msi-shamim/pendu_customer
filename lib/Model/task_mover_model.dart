...
//
//     final postTaskMoverModel = postTaskMoverModelFromMap(jsonString);

import 'dart:convert';

class PostTaskMoverModel {
  PostTaskMoverModel({
    this.status,
    this.message,
    this.data,
  ...
  factory PostTaskMoverModel.fromJson(String str) => PostTaskMoverModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory PostTaskMoverModel.fromMap(Map<String, dynamic> json) => PostTaskMoverModel(
