  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: AppBarCommonUtils('Movers'),
      ),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 15),
              ProgressPageHeaderTextUtils(text: 'Task title'),
              SizedBox(height: 8),
              //Todo
              Container(
              ...
              SizedBox(height: 10),
              ProgressPageHeaderTextUtils(text: 'Items'),
              SizedBox(height: 8),
              ...
              ProgressPageHeaderTextUtils(text: 'Pickup address'),
              SizedBox(height: 8),
              //Todo TextField
              Container(
                color: Colors.grey[200],
