...
import 'package:pendu_customer/screen_common/page_payment_done.dart';
...
class CollectDropCheckOutPage extends StatefulWidget {
  @override
  _CollectDropCheckOutPageState createState() => _CollectDropCheckOutPageState();
}

class _CollectDropCheckOutPageState extends State<CollectDropCheckOutPage> {
  int selectedIndex = -1;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: AppBarCommonUtils('CheckOut'),
      ),
